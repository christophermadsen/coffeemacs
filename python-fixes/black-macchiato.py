# A black macchiato fix for Windows, thanks to:
# https://github.com/wbolster/black-macchiato/issues/13
...
def wrap_lines(lines: List[str]) -> Tuple[List[str], WrapInfo]:
    ...
    if not lines:
        wrap_info = WrapInfo(
            n_blank_before=n_blank_before, n_blank_after=n_blank_after
        )
